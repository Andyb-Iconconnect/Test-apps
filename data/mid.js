 ...
 * with no lookup, no network and no typing.
 *
 * Every ship-station MID is here — the whole 201–775 range, not just the ones a
 * yacht is likely to fly. The short list this started as was fine until a real
 * fleet arrived carrying a Malaysian MMSI, whose flag came back blank for no
 * better reason than that nobody had expected it.
 *
 * Source: the ITU MID allocation. Codes are stable — reallocations are rare and
...
window.MID = {
  ...
  274: ['MK', 'Macedonia'],      275: ['LV', 'Latvia'],
  276: ['EE', 'Estonia'],        277: ['LT', 'Lithuania'],
  278: ['SI', 'Slovenia'],       279: ['RS', 'Serbia'],

  /* --- North and Central America, and the Caribbean ------------------------ */
  301: ['AI', 'Anguilla'],       303: ['US', 'Alaska'],
  ...
  312: ['BZ', 'Belize'],         314: ['BB', 'Barbados'],
  316: ['CA', 'Canada'],         319: ['KY', 'Cayman Islands'],
  321: ['CR', 'Costa Rica'],     323: ['CU', 'Cuba'],
  325: ['DM', 'Dominica'],       327: ['DO', 'Dominican Republic'],
  329: ['GP', 'Guadeloupe'],     330: ['GD', 'Grenada'],
  331: ['GL', 'Greenland'],      332: ['GT', 'Guatemala'],
  334: ['HN', 'Honduras'],       336: ['HT', 'Haiti'],
  338: ['US', 'United States'],  339: ['JM', 'Jamaica'],
  341: ['KN', 'Saint Kitts and Nevis'],343: ['LC', 'Saint Lucia'],
  345: ['MX', 'Mexico'],         347: ['MQ', 'Martinique'],
  ...
  359: ['SV', 'El Salvador'],    361: ['PM', 'Saint Pierre and Miquelon'],
  ...
  374: ['PA', 'Panama'],         375: ['VC', 'Saint Vincent and the Grenadines'],
  376: ['VC', 'Saint Vincent and the Grenadines'],377: ['VC', 'Saint Vincent and the Grenadines'],
  ...
  659: ['NA', 'Namibia'],        660: ['RE', 'Reunion'],
  661: ['RW', 'Rwanda'],         662: ['SD', 'Sudan'],
  663: ['SN', 'Senegal'],        664: ['SC', 'Seychelles'],
  665: ['SH', 'Saint Helena'],   666: ['SO', 'Somali Democratic Republic'],
  667: ['SL', 'Sierra Leone'],   668: ['ST', 'Sao Tome and Principe'],
  669: ['SZ', 'Swaziland'],      670: ['TD', 'Chad'],
  671: ['TG', 'Togo'],           672: ['TN', 'Tunisian Republic'],
  674: ['TZ', 'Tanzania'],       675: ['UG', 'Uganda'],
  676: ['CD', 'Democratic Republic of the Congo'],677: ['TZ', 'Tanzania'],
  ...
  740: ['FK', 'Falkland Islands'],745: ['GF', 'Guiana'],
